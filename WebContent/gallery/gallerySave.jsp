...
<%
	...
	String path = "C:\\0524_java_LBG\\upload";		// 파일 업로드 경로
	...
	//		ㄴ 해쉬값(랜덤문자열) 이용하거나 업로드 날짜 시간을 이용해서 파일명을 변경할 수 있습니다.
	
	// request 객체 대신에 multiRequest 사용합니다. -> 파일 전송을 처리하는 객체
	String title = multiRequest.getParameter("title");
	String filename = multiRequest.getFilesystemName("pic");	// flie 타입의 파일명 가져오는 메소드
